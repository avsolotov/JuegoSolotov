...
{
    public partial class GeografiaFive : Form
    {
        public GeografiaFive()
        {
            //INICIE LA INTERFAZ GEOGRAFIA FIVE
            InitializeComponent();
        }
        ...
        private void Btncorrecto_Click(object sender, EventArgs e)
        {
            ...
            Hide();
            //LLAME Y MUESTRE ME LA INTERFAZ GEOGRAFIA FIVE
            var socialesfive = new SocialesFive();
            socialesfive.Show();
        }
        ...
        private void GeografiaFive_Load(object sender, EventArgs e)
        {
