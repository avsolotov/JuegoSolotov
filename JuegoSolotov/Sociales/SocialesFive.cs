...
{
    public partial class SocialesFive : Form
    {
        public SocialesFive()
        {
            //INICIE LA INTERFAZ SOCIALES FIVE
            InitializeComponent();
        }
        ...
        private void Btncorrecto_Click(object sender, EventArgs e)
        {
            ...
            Hide();
            //LLAME Y MUESTRE ME LA INTERFAZ GEOGRAFIA SIX
            var geografiasix = new GeografiaSix();
            geografiasix.Show();
        }
        ...
        private void SocialesFive_Load(object sender, EventArgs e)
        {
