...
{
    public partial class MatematicasSeven : Form
    {
        public MatematicasSeven()
        {
            //INICIE LA INTERFAZ MATEMATICAS SEVEN
            InitializeComponent();
        }
        ...
        private void Btncorrecto_Click(object sender, EventArgs e)
        {
            ...
            Hide();
            //LLAME Y MUESTRE ME LA INTERFAZ CIENCIA SEVEN
            var cienciasseven = new CienciasSeven();
            cienciasseven.Show();
        }
        ...
        private void MatematicasSeven_Load(object sender, EventArgs e)
        {
