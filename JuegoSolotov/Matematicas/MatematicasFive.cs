...
{
    public partial class MatematicasFive : Form
    {
        public MatematicasFive()
        {
            //INICIE LA INTERFAZ MATEMATICAS FIVE
            InitializeComponent();
        }
        ...
        private void Btncorrecto_Click(object sender, EventArgs e)
        {
            ...
            Hide();
            //LLAME Y MUESTRE ME LA INTERFAZ CIENCIA FIVE
            var cienciafive = new CienciaFive();
            cienciafive.Show();
        }
        ...
        private void MatematicasFive_Load(object sender, EventArgs e)
        {
