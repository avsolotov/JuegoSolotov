...
{
    public partial class MatematicasSix : Form
    {
        public MatematicasSix()
        {
            //INICIE LA INTERFAZ MATEMATICAS SIX
            InitializeComponent();
        }
        ...
        private void Btncorrecto_Click(object sender, EventArgs e)
        {
            ...
            Hide();
            //LLAME Y MUESTRE ME LA INTERFAZ CIENCIA SIX
            var cienciassix = new CienciaSix();
            cienciassix.Show();
        }
        ...
        private void MatematicasSix_Load(object sender, EventArgs e)
        {
