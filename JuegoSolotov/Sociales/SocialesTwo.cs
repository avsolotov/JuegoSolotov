...
{
    public partial class SocialesTwo : Form
    {
        public SocialesTwo()
        {
        ...
        private void Btncorrecto_Click(object sender, EventArgs e)
        {
            ...
            var matematicasfour = new MatematicasFour();
            matematicasfour.Show();
        }
        ...
        private void SocialesTwo_Load(object sender, EventArgs e)
        {
